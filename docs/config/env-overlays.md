...
- Static config fields:
  ...
  - `executionTimeoutMs?: number` — max wall time in ms (default 3600000; 0 disables).
  - `idleTimeoutMs?: number` — max idle time with no output in ms (default 60000; 0 disables).
- Behavior:
