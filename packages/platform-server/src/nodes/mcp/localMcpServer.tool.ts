...
export interface McpExecDelegate {
	callTool: (name: string, args: any) => Promise<{ isError?: boolean; content?: string; structuredContent?: unknown; raw?: unknown }>;
...
export const GenericMcpInvocationSchema = z.object({
...
export class LocalMCPServerTool extends LLMFunctionTool<typeof GenericMcpInvocationSchema> {
	constructor(private deps: LocalMCPServerToolDeps, private inputSchema?: z.ZodObject<any>) { super(); }
	get name() { return this.deps.getName(); }
	get description() { return this.deps.getDescription(); }
	get schema() { return this.inputSchema || GenericMcpInvocationSchema; }
