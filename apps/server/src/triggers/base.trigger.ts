...
export abstract class BaseTrigger implements Pausable, Provisionable {
  ...
  constructor() {
    // No options needed anymore - triggers are now just I/O sources
  }
  ...
  /**
   * External triggers call this to notify listeners immediately.
   * No buffering or debouncing - that's now handled by the Agent.
   */
